...
https://pmd.github.io/pmd-6.40.0/pmd_rules_apex_bestpractices.html#unusedlocalvariable`, {
    ...
    it('can deal with error, warning and notice', () => {
        ...
        // todo fix tests
        /*expect(core.error).toHaveBeenNthCalledWith(1, '(0 - high prio rule) (Priority: 1, Ruleset: sample ruleset)', { title: 'High Prio Rule', file: '/folder/file1.txt', startLine: 4, endLine: 5 });
